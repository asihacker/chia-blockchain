...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        data = {
            ...
            "address": encode_puzzle_hash(create_puzzlehash_for_pk(master_sk_to_wallet_sk(sk, uint32(0)).get_g1()),
                                          prefix),
            "master": sk.get_g1(),
            "farmer": master_sk_to_farmer_sk(sk).get_g1(),
            "pool": master_sk_to_pool_sk(sk).get_g1(),
        }
